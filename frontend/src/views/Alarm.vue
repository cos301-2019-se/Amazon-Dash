...
<v-tab-item>
    <v-card flat>
        <v-container>
            <v-layout row wrap>
                <div class="display-2 pb-2"><v-text>Metric</v-text></div>
            </v-layout>

            <v-divider></v-divider>
            <div class="pt-3 ml-2 grey--text"><v-text>Graph</v-text></div>
    ...
    <layout row>
        <v-container>
            <v-card flat>
                ...
                <v-flex xs12 md12>
                    <v-btn solo text class="normal right " @click="cancel()"><v-text class=""><v-text>Cancel</v-text></v-text></v-btn>
                </v-flex>    
              </v-card>
        </v-container>
    </layout>
...
<!-------------------------------------------------Second Tab begins---------------------------------------------->
<v-tab >
  <v-text>2. Specify metric and condition</v-text>
</v-tab>
<v-tab-item >
    <v-card flat>
          <v-container>
            ...
            <v-container>
                <v-card flat class="">
                    <v-layout row>
                        <v-flex xs6 md6>
                            <v-card flat>
                                <div class="display-1 pb-2 grey--text"><v-text>Graph</v-text></div>
                                <p class="grey--text"><v-text>This alarm will trigger when the blue line goes above the red line</v-text></p>
                            </v-card>
    ...
    <layout row>
        <v-container>
            <v-card flat>
                ...
                <v-flex xs12 md12>
                    <v-btn solo class="normal right" @click="cancel()"><v-text>Cancel</v-text></v-btn>
                </v-flex>
            </v-card>
        </v-container>
    </layout>
...
<!----------------------------------------- Third Tab Begins---------------------------------------------------------------------------------->
<v-tab>
    <v-text>3. Configure actions</v-text>
</v-tab>
<v-tab-item >
    <v-card flat>
...
<!--------------------------------------------- Fourth Tab Begins------------------------------------------------------------------------------------->
<v-tab >
    <v-text>4. Add a description</v-text>
</v-tab>
<v-tab-item >
    <v-card flat>
                <!-- Container for headings -->
    ...
    <layout row>
        <v-container>
            <v-card flat>
                ...
                <v-flex xs12 md12>
                    <v-btn solo class="normal right blue--text" @click="cancel()"><v-text>Cancel</v-text></v-btn>
                </v-flex>
...
<!-------------------------------------------------------------- Fifth Tab BEGINS  ---------------------------------------------------------------------------->
<v-tab >
    <v-text><v-text>5. Preview and create</v-text></v-text>
    </v-tab>
        <v-tab-item >
            <v-card flat>
                      <!-- Container for headings -->
                ...
                <v-container>
                    <v-card flat>
                        <v-layout row wrap>
                            <v-flex xs12 md12>
                                <div class="display-1  grey--text"><v-text>Conditions</v-text></div>
                                <v-divider></v-divider>
                            </v-flex>
                            <!-- Threshold type -->
                            <v-flex xs12 md12>
